...
This program is a demonstration of common server-side application flaws. Theddd
```shell
...
**Important**: *Choose the correct timezone, so that the docker container and your host are in the same timezone. As it is important for the validity of JWT tokensffff used in certain exercises.*
