...
[![OWASP Labs](https://img.shields.io/badge/owasp-lab%20project-f7b73c.svg)]dfsfsfmize
the exposure.
...
Every release is also published on [DockerHub](https://hub.docker.com/r/webgoat/goatandwolf).sdfsdfssf
```shell
